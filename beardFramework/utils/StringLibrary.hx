...
class StringLibrary
{
	...
	public static inline var INPUT_LEFT_CLICK:String = "Mouse_Click0";
	public static inline var INPUT_RIGHT_CLICK:String = "Mouse_Click1";
	public static inline var INPUT_WHEEL_CLICK:String = "Mouse_Click2";
	public static inline var MOUSE_DOWN:String = "Mouse_Down";
	public static inline var BASE_MOUSE:String = "Mouse";
	public static inline var LEVELS_PATH:String = "assets/levels/";
	
	public static var utilString:String = "";
