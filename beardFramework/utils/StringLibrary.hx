...
class StringLibrary
{
	...
	public static inline var INPUT_LEFT_CLICK:String 		= "mouseClick0";
	public static inline var INPUT_RIGHT_CLICK:String 		= "mouseClick1";
	public static inline var INPUT_WHEEL_CLICK:String		= "mouseClick2";
