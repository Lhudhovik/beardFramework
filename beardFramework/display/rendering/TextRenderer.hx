 ...
 * @author 
 */
class TextRenderer extends DefaultRenderer
{

	private static var instance:TextRenderer;
	...
	public static inline function Get():TextRenderer
	{
		if (instance == null)
		{
	...
	override public function UpdateRenderedData():Void
	{
		...
		if (ready && renderedData.count > 0)
		{
			...
			for (i in 0...dirtyObjects.length)
			{
				...
				textfield = cast(dirtyObjects.get(i) , TextField);
