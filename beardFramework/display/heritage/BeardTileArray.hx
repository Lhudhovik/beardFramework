 ...
 * @author 
 */
class BeardTileArray implements ITile 
{
	...
	private function __updateGLBufferThroughCamera (gl:GLRenderContext, defaultTileset:Tileset, worldAlpha:Float, defaultColorTransform:ColorTransform):GLBuffer 
	{
...
private class TileArrayIterator {
	...
	private var data:BeardTileArray;
	private var position:Int;
	
	
	private function new (data:BeardTileArray) {
