...
class BeardGLTilemap {
	...
	public static function renderThroughCamera (tilemap:BeardTileMap, renderSession:RenderSession, camera:Camera):Void {
		...
		tilemap.__updateTileArrayThroughCamera (camera);
		...
		cast(tileArray,BeardTileArray).__updateGLBufferThroughCamera (gl, defaultTileset, tilemap.__worldAlpha, tilemap.__worldColorTransform,camera);
