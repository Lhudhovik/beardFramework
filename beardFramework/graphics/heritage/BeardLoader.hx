package beardFramework.graphics.heritage;

import beardFramework.graphics.heritage.BeardDisplayObjectContainer;
import haxe.io.Path;
...
class BeardLoader extends BeardDisplayObjectContainer {
